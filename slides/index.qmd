...
## Nicht jede kognitive Anstrengung führt zu lernen {.smaller}
...
## Lernrelevante Anstrengung ermöglichen {.smaller}
...
Auslagerung lernhinderlicher kognitiver Last an externe Hilfsmittel [@riskoCognitiveOffloading2016].
...
Auslagerung lernrelevanter kognitiver Last an externe Hilfsmittel [@riskoCognitiveOffloading2016].
...
Eine Studierende nutzt KI als *advocatus diaboli*, um ihre Argumentation für eine Debatte zu festigen. 

Ein Studierender lässt sich von KI einen Lernplan für ein Thema erstellen.

Eine Studierende nutzt KI, um die von ihr geschriebene Studienarbeit sprachlich zu überarbeiten.
...
**Antwort 1**: KI-Nutzung bei Studierenden verstärkt Selbstwirksamkeitserwartung bei zeitgleich reduzierter Leistungsfähigkeit. <!-- Zitiere Jia et al. 2025 -->
<!-- Metakognitive Falle, AI dependency & self-efficacy -->
<!-- Bewertung von KI-Output -->
<!-- Handlungsausrichtung an langfristigen Zielen -->

## Exkurs: Kann jeder KI nutzen?
<!-- Konsequenz: KI-Nutzung bewusst gestalten -->
